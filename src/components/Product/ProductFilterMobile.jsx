            ...
            {(onClose) => (
              <>
                ...
                <Accordion selectionMode="multiple">
                  <AccordionItem key="1" aria-label={data?.categorydetail?.collection} classNames={{indicator:"rotate-[270deg] data-[open=true]:rotate-90" }} title={
                  ...
                  <AccordionItem key="2" classNames={{indicator:"rotate-[270deg] data-[open=true]:rotate-90" }} aria-label={data?.categorydetail?.size} title={
