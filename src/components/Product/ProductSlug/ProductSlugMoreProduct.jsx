      ...
      <div className="max-w-6xl mx-auto px-6 xl:px-0 pb-[56px] md:pb-[64px] lg:pb-[72px] xl:pb-[80px]">
        <div className="flex flex-col justify-start md:justify-between items-center md:items-start w-full h-full gap-x-[5%] gap-y-[32px] sm:gap-y-[40px] md:gap-y-[48px] lg:gap-y-[56px]">
          ...
          <div className="flex justify-between items-center w-full gap-x-[24px]">
            ...
            <Link href={'/product'} className="group flex items-center gap-x-[8px]">
              <p className='text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] text-[#070709] font-[500] uppercase leading-[125%] tracking-[4px]'>
                view all
              </p>
