        ...
        <div className='max-w-full'>
            <div className='flex flex-col justify-center items-center w-full h-full relative'>
              ...
              <div className="flex justify-center items-center w-full h-full z-[5]">
                <Image className=" object-cover object-center w-full h-[400px] md:h-full" src={urlFor(data?.mainImage?.image).format("png").url()} radius="none" alt={data?.mainImage?.alt} width={1690} height={400}/>
              </div>
